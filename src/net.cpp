...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fishcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"fishcointools.com", "dnsseed.fishcointools.com"},
    {"fishcoinpool.org", "dnsseed.fishcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"fishcointools.com", "testnet-seed.fishcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fishcoin is probably already running."), addrBind.ToString().c_str());
        else
